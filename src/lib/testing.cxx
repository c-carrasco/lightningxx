...
// ----------------------------------------------------------------------------
Response Client::request (HttpMethod method, std::string_view target,
  ...
  if (target.empty()) throw std::invalid_argument ("Empty request target");
  ...
  if (!headers.contains ("host")) wire += "host: localhost\r\n";
